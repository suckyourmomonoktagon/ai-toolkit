...
- **Coverage**: Includes workflow regression checks for `copilot/*` PR-title skip behavior, including the wired `SKIP_REASON` fallback assignment for coding-agent branches, alongside the prompt-builder tests
