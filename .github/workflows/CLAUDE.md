...
- `claude-docs-check.yml` - Validates PR documentation is properly updated (CLAUDE.md, README, versions); skips cleanly when neither Claude auth secret is configured
